  ...
  <div className="flex items-center justify-center gap-12 flex-col xl:flex-row">
    ...
    <div className="flex flex-1 flex-col pt-12 xl:pt-32">
      ...
      <div className='mt-6'>
        <Link
          to="/store"
          className="text-white bg-indigo-600 hover:bg-indigo-700 ring-1 ring-offset-2 ring-indigo-600 p-12  rounded-full font-bold transition-all duration-300 shadow-md"
        >
          Explore Now
        </Link>
      </div>
